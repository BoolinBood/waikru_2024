...
const CreateTray: React.FC<Props> = ({ selectedFlower }) => {
  ...
  const handleMessageChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    console.log(`Message Length: ${value.length}`); // Log the length of the message
    ...
    setValue("message", value, { shouldValidate: true }); // Update form value and trigger validation
  };
